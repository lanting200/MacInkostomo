...
- 生成与修订在送审前先过本地确定性校验：清单式条目铺陈、叙述边界上的“第28天/雨季第28天”式绝对纪日、总结或淡出式收尾直接退稿；“第二天一早”等相对过渡和角色在对话、台账、物资心算中引用日期保留。前三章作为开篇段整体至少建立一次核心能力异常锚点，前章已经建立后不要求后续章重复，且节拍卡的禁止清单优先于重复锚点。这些规则与审核模型的同类 `[hard][prose]` 规则互为兜底。
